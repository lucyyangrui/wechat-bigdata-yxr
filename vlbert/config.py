...
def parse_args():
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='save/finetune/last-ckp')
    ...
    parser.add_argument('--warm_up_ratio', default=0.0, type=float, help="warm up ratio")
    ...
    parser.add_argument('--use_fgm', default=True, type=bool, help="fgm use or not")
    parser.add_argument('--fold_num', default=5, type=int, help="kfold num")
